...
seir <- function(t, y, pars){
  ...
  ## Vaccination rates
  vacc_child_rate <- min(vacc_child(t)*pop_child/(S_1_child + S_2_child + S_2E_child + S_3_child + S_3E_child), 1)
  vacc_adult_rate <- min(vacc_adult(t)*pop_adult/(S_1_adult + S_2_adult + S_2E_adult + S_3_adult + S_3E_adult),1)
  vacc_hr_rate <- min(vacc_hr(t)*pop_hr/(S_1_hr + S_2_hr + S_2E_hr + S_3_hr + S_3E_hr),1)
  vacc_old_rate <- min(vacc_old(t)*pop_old/(S_1_old + S_2_old + S_2E_old + S_3_old + S_3E_old),1)
  ...
  ## Boosted
  dS_2_child <- - (1-(1-VE_i))*lambda_child*S_2_child - omega*S_2_child + vacc_child_rate*S_1_child + vacc_child_rate*S_2E_child + vacc_child_rate*S_3_child + 
  ...
  dS_2E_child <- - (1-(1-VE_i)*immesc_prop)*lambda_child*S_2E_child - omega*S_2E_child + immesc*S_2_child - vacc_child_rate*S_2E_child
  ...
  ## Boosted
  dS_2_adult <- - (1-(1-VE_i))*lambda_adult*S_2_adult - omega*S_2_adult + vacc_adult_rate*S_1_adult + vacc_adult_rate*S_2E_adult + vacc_adult_rate*S_3_adult + 
  ...
  ## Boosted, immune escape
  dS_2E_adult <- - (1-(1-VE_i)*immesc_prop)*lambda_adult*S_2E_adult - omega*S_2E_adult + immesc*S_2_adult - vacc_adult_rate*S_2E_adult
  ...
  ## Boosted
  dS_2_old <- - (1-(1-VE_i))*lambda_old*S_2_old - omega*S_2_old + vacc_old_rate*S_1_old + vacc_old_rate*S_2E_old + vacc_old_rate*S_3_old + 
  ...
  ## Boosted, immune escape
  dS_2E_old <- - (1-(1-VE_i)*immesc_prop)*lambda_old*S_2E_old - omega*S_2E_old + immesc*S_2_old - vacc_old_rate*S_2E_old
  ...
  ## Boosted
  dS_2_hr <- - (1-(1-VE_i))*lambda_hr*S_2_hr - omega*S_2_hr + vacc_hr_rate*S_1_hr +  vacc_hr_rate*S_2E_hr + vacc_hr_rate*S_3_hr + 
  ...
  ## Boosted, immune escape
  dS_2E_hr <- - (1-(1-VE_i)*immesc_prop)*lambda_hr*S_2E_hr - omega*S_2E_hr + immesc*S_2_hr - vacc_hr_rate*S_2E_hr
